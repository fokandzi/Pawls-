...
async function verifyScratch(sql: any) {
  const checks: Array<[string, string]> = [
    ...
    // 002 schema foundation
    ["users.region", "SELECT 1 FROM information_schema.columns WHERE table_name='users' AND column_name='region'"],
    ["dog_profiles.date_of_birth", "SELECT 1 FROM information_schema.columns WHERE table_name='dog_profiles' AND column_name='date_of_birth'"],
    ["dog_profiles.profile_visibility", "SELECT 1 FROM information_schema.columns WHERE table_name='dog_profiles' AND column_name='profile_visibility'"],
    ["dog_profiles.source", "SELECT 1 FROM information_schema.columns WHERE table_name='dog_profiles' AND column_name='source'"],
    ["dog_profiles.updated_at", "SELECT 1 FROM information_schema.columns WHERE table_name='dog_profiles' AND column_name='updated_at'"],
    ["swipes.unique3", "SELECT count(*)::text AS n FROM information_schema.key_column_usage WHERE constraint_name='swipes_unique_swiper_target_direction' AND table_name='swipes'"],
    ["matches.order_check", "SELECT 1 FROM pg_constraint c JOIN pg_class r ON r.oid=c.conrelid WHERE r.relname='matches' AND c.contype='c' AND c.conname='matches_profile_order_check'"],
    ["matches.state", "SELECT 1 FROM information_schema.columns WHERE table_name='matches' AND column_name='state'"],
    ["conversations", "SELECT 1 FROM information_schema.tables WHERE table_name='conversations'"],
    ["conversation_participants", "SELECT 1 FROM information_schema.tables WHERE table_name='conversation_participants'"],
    ["messages", "SELECT 1 FROM information_schema.tables WHERE table_name='messages'"],
    ["messages.body_check", "SELECT 1 FROM pg_constraint c JOIN pg_class r ON r.oid=c.conrelid WHERE r.relname='messages' AND c.contype='c' AND c.conname='messages_body_check'"],
    ["blocks", "SELECT 1 FROM information_schema.tables WHERE table_name='blocks'"],
    ["reports", "SELECT 1 FROM information_schema.tables WHERE table_name='reports'"],
    ["commission_configs", "SELECT 1 FROM information_schema.tables WHERE table_name='commission_configs'"],
    ["providers.no_rating_default", "SELECT 1 FROM information_schema.columns WHERE table_name='providers' AND column_name='rating' AND column_default IS NULL"],
    ["providers.approval_status", "SELECT 1 FROM information_schema.columns WHERE table_name='providers' AND column_name='approval_status'"],
    ["providers.owner_user_id", "SELECT 1 FROM information_schema.columns WHERE table_name='providers' AND column_name='owner_user_id'"],
    ["providers.is_demo", "SELECT 1 FROM information_schema.columns WHERE table_name='providers' AND column_name='is_demo'"],
    ["services.currency", "SELECT 1 FROM information_schema.columns WHERE table_name='services' AND column_name='currency'"],
    ["services.is_active", "SELECT 1 FROM information_schema.columns WHERE table_name='services' AND column_name='is_active'"],
    ["bookings.payment_status", "SELECT 1 FROM information_schema.columns WHERE table_name='bookings' AND column_name='payment_status'"],
    ["bookings.platform_fee_rate", "SELECT 1 FROM information_schema.columns WHERE table_name='bookings' AND column_name='platform_fee_rate'"],
    ["bookings.customer_user_id", "SELECT 1 FROM information_schema.columns WHERE table_name='bookings' AND column_name='customer_user_id'"],
    ["bookings.updated_at", "SELECT 1 FROM information_schema.columns WHERE table_name='bookings' AND column_name='updated_at'"],
    ["subscriptions.plan_default_none", "SELECT 1 FROM information_schema.columns WHERE table_name='subscriptions' AND column_name='plan' AND column_default LIKE '%none%'"],
    ["subscriptions.user_id", "SELECT 1 FROM information_schema.columns WHERE table_name='subscriptions' AND column_name='user_id'"],
    ["breeders.is_demo", "SELECT 1 FROM information_schema.columns WHERE table_name='breeders' AND column_name='is_demo'"],
    ["shelters.is_demo", "SELECT 1 FROM information_schema.columns WHERE table_name='shelters' AND column_name='is_demo'"],
    ["venues.is_demo", "SELECT 1 FROM information_schema.columns WHERE table_name='venues' AND column_name='is_demo'"],
    ["venues.no_rating_default", "SELECT 1 FROM information_schema.columns WHERE table_name='venues' AND column_name='rating' AND column_default IS NULL"],
    ["idx_messages_conversation_created_at", "SELECT 1 FROM pg_indexes WHERE tablename='messages' AND indexname='idx_messages_conversation_created_at'"],
    ["idx_bookings_status", "SELECT 1 FROM pg_indexes WHERE tablename='bookings' AND indexname='idx_bookings_status'"],
    ["idx_reports_status", "SELECT 1 FROM pg_indexes WHERE tablename='reports' AND indexname='idx_reports_status'"],
  ];
  let ok = true;
