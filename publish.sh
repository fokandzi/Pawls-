...
# Override bogus DATABASE_URL from parent environment with the real value from .env.
# The shell may have a stale/broken value; Bun's .env loader won't override it.
if [ -f .env ]; then
